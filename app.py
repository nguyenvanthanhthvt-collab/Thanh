...
<div class="main-header">
    ...
    <p>Tác giả: Nguyễn Văn Thành - Trường Tiểu học Vĩnh Thành - ĐT: 0916252092</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nguyễn Văn Thành - Trường Tiểu học Vĩnh Thành - ĐT: 0916252092</div>", unsafe_allow_html=True)
